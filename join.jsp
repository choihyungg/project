...
<body>
 <script src="https://spi.maps.daum.net/imap/map_js_init/postcode.v2.js"></script>
	...
	<form action="member_insert_action.jsp" name="member_insert" method="post">
		...
		<tr>
		<td> 성별 </td>
		<td ><select name="gender" class="gender"><option value="남성">남성</option>
	...
	<div class="btnWarp">
	<input type="button" class="btn" style="cursor: pointer" value="취소하기">
	<input type="button" class="btn" style="cursor: pointer" value="가입하기">
	</div>
</body>
</html>